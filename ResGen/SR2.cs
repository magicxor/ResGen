...
namespace ResGen
{
    internal sealed class SR2
    {
        ...
        private static SR2 loader;
        private ResourceManager resources;

        internal SR2() => this.resources = new ResourceManager(typeof(Resources));
        ...
        private static SR2 GetLoader()
        {
            ...
            {
                var sr = new SR2();
                Interlocked.CompareExchange<SR2>(ref SR2.loader, sr, (SR2) null);
            }
            return SR2.loader;
        }
        ...
        public static ResourceManager Resources => SR2.GetLoader().resources;

        public static string GetString(string name, params object[] args)
        {
            var loader = SR2.GetLoader();
            if (loader == null)
                return (string) null;
            string format = loader.resources.GetString(name, SR2.Culture);
        ...
        {
            return SR2.GetLoader()?.resources.GetString(name, SR2.Culture);
        }

        public static string GetString(string name, out bool usedFallback)
        {
            usedFallback = false;
            return SR2.GetString(name);
        }

        public static object GetObject(string name)
        {
            return SR2.GetLoader()?.resources.GetObject(name, SR2.Culture);
        }
    }
}
